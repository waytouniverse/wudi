...
**无敌** 由 [阿旬同学](https://ai.wudiyuzhou.top/)（叶远旬）打造。

> 把大模型从 PPT 搬进生产线。不做「聊天气泡式」AI，只做能直接算 ROI 的落地场景。

- **角色**：AI 产品研发框架师 · 企业场景应用创新专家 · 算法工程师 · 珠海青年夜校讲师
- **背景**：11 年产品 + 技术管理经验，信息工程科班出身。带着一支不到 5 人的 OPC 团队，把过去需要几十人干几周的产业数据分析和招商研判，压缩成一句话的 AI 问答。主导的「问小数」大模型智能助手（自研双塔 + Qwen 混合架构，整合 200 万企业核心数据、8 大产业链知识图谱与 4.1 亿商业联系方式，Recall@3 达 97%+）已落地火炬产投、翠亨集团、南京银行、广州建筑等头部政企。
- **社区**：WaytoAGI 开源社区核心共建者、模力社区联合发起人，在中山/珠海组织多场 AI 沙龙与黑客松。
